 ...
 */
class NewApiTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->connection = $this->getMockBuilder(ApiConnectionInterface::class)->getMock();
